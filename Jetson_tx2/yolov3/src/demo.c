...
#define PORT 8702       //연결하려는 서버의 PORT
...
//		printf("****Detecting count=%d\n",count);
        	...
        	if(!prefix){
			if (count%20==0){
	                        fps = 20./(what_time_is_it_now() - demo_time);
				demo_time=what_time_is_it_now();
