...
#		print('Average max-Q = {}'.format(sum(avg_q_max_data)/len(avg_q_max_data)))
	...
	if len(ts)>100:
		...
		f=open('power30_zTT.csv','w',encoding='utf-8',newline='')
		wr=csv.writer(f)
		...
		f=open('temp30_zTT.csv','w',encoding='utf-8',newline='')
		wr=csv.writer(f)
		...
		f=open('clock30_zTT.csv','w',encoding='utf-8',newline='')
		wr=csv.writer(f)
		...
		f=open('fps30_zTT.csv','w',encoding='utf-8',newline='')
		wr=csv.writer(f)
